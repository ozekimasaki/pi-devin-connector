...
export async function registerUser(
  ...
  // Login users on flaky networks need bounded waits or the sign-in flow
  // hangs forever. Compose with the caller's signal via AbortSignal.any
  // (built-in on our engines floor, Node ≥22.19).
