...
export interface OAuthLoginResult {
   ...
   * tenant — empty in the RegisterUser response falls back to the default.
   */
  apiServerUrl: string;
...
/**
 * The single tenant (free / personal) configuration. EU, FedStart, and
 * arbitrary portal URLs would override `website` + `registerApiServerUrl`.
 */
